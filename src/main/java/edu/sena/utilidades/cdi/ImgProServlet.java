 ...
 */
package edu.sena.utilidades.cdi;
 ...
 * @author Josarta
 */
@WebServlet(name = "ImgProServlet", urlPatterns = {"/ImgProServlet/*"})
public class ImgProServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!archivoNombre.isEmpty()) {
            File carpeta = new File("C:\\cdi\\productos\\" + archivoNombre);
